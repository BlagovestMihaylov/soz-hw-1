...
public class Chromosome implements Comparable<Chromosome>{
	private final int MAX_LENGTH; 					//n size
	private final int[] gene; 						//contains the location of each queen
	 ...
	 *
	 * @return: boolean value if selected
	 */
	...
	/* Gets whether the chromosome is selected.
	 *
	 * @param: boolean value if selected
	 */
